...
<template>
  <div class="w-full max-w-2xl rounded-xl border border-amber-500/15 bg-amber-500/5 p-4">
    ...
    <div class="mt-3 space-y-1.5">
      <div
        ...
        class="flex items-start gap-2.5 rounded-lg bg-(--surface-elevated) px-3 py-2.5 ring-1 ring-(--border-subtle)"
      >
